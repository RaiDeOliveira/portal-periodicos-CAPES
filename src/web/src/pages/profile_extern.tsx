...
const articles: ArticleProps[] = [
    ...
    {
      avatarSrc: "/people/5.png",
      title: "Deep Learning Approaches to Cybersecurity Threat Detection and Mitigation",
      author: "Junjie Whang, Takashi Kobayashi, Yuki Tanaka, Sora Kimura e Hina Watanabe",
      description:
    ...
    {
      avatarSrc: "/people/5.png",
      title: "Optimizing Neural Networks for Edge Computing: Challenges and Solutions",
      author: "Junjie Whang, Naoki Suzuki, Li Wei, Riko Nakamura e Haruto Yamashita",
      description:
...
export function ExternProfile() {
  const [following, setFollowing] = useState<boolean[]>(new Array(relatedResearchers.length).fill(false));
  ...
  return (
    <div className="font-rawline pt-32 px-16 pb-8 bg-white">
      <h1 className="font-rawline font-semibold text-2xl mb-8 text-[#001D6C]">Perfil</h1>
      <div className="flex items-center space-x-12">
        ...
        <div>
          <h2 className="font-rawline font-semibold text-2xl text-[#001D6C] mb-3">Junjie Wang</h2>
          <p className="text-gray-600 text-sm mb-3">Alma Mater: MIT - Massachussets Institute of Technology</p>
          <p className="text-gray-600 text-sm mb-3">Áreas de atuação: ciência da computação, ciência de dados</p>
          <div className="flex items-center space-x-3">
            <a href="http://lattes.cnpq.br/7391655378104188" target="_blank" rel="noopener noreferrer">
              <img src="/assets/logo_lattes.png" className="h-12 w-auto" alt="Logo Lattes" />
            </a>
            <a href="https://www.linkedin.com/in/carleane-reis-4a39351a7/" target="_blank" rel="noopener noreferrer">
              <img src="/assets/logo_linkedin.png" className="h-16 w-auto" alt="Logo LinkedIn" />
            </a>
            <a href="https://openalex.org/works?page=1&filter=authorships.author.id%3Aa5026738610" target="_blank" rel="noopener noreferrer">
              <img src="/assets/logo_open_alex.png" className="h-12 w-auto mr-4" alt="Logo OpenAlex" />
            </a>
            <button
              ...
              className={`group flex items-center justify-center gap-2 font-bold border border-[#001D6C] py-2 px-4 rounded-md transition-colors w-32 ${
                following[0] ? "bg-[#001D6C] text-white" : "bg-white text-[#001D6C] hover:bg-[#001D6C] hover:text-white"
              }`}
            >
      ...
      {/* Artigos para você */}
      <div className="py-12">
        <h3 className="font-rawline font-semibold text-xl text-[#001D6C] mb-6">Artigos publicados</h3>
                ...
                <div className="flex items-center space-x-4 justify-between w-full">
                  <div className="flex items-center space-x-4">
                    <Avatar className="w-12 h-12">
                      <img src={article.avatarSrc} alt="Avatar" className="rounded-full" />
                    </Avatar>
                    <CardTitle className="flex items-center">{article.title}</CardTitle>
                  </div>
                  <img src="/save.svg" alt="Salvar" className="pl-4 h-6 cursor-pointer" />
                </div>
      ...
      <div className="mt-12">
        <h3 className="font-rawline font-semibold text-xl text-[#001D6C] mb-6">Pesquisadores Relacionados</h3>
          ...
          {relatedResearchers.map((researcher, index) => (
            <Card key={index} className="w-52 h-72 shadow-md flex flex-col items-center p-6">
              <Avatar className="w-24 h-24 mb-4">
                <img src={researcher.avatarSrc} alt="Avatar" className="rounded-full" />
              </Avatar>
